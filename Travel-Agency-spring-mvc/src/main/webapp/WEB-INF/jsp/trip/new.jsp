...
<jsp:attribute name="body">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/trip/create"
        ...
        <div class="form-group ${spots_error?'has-error':''}">
            <form:label path="spots" cssClass="col-sm-2 control-label">Number of spots</form:label>
            <div class="col-sm-10">
                <form:input path="spots" cssClass="form-control"/>
                <form:errors path="spots" cssClass="help-block"/>
            </div>
        </div>
