<%-- 
    Document   : new
    Created on : 18.12.2017, 17:23:20
...
<my:pagetemplate>
<jsp:attribute name="title"><f:message key="excursion.new"/></jsp:attribute>
<jsp:attribute name="body">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/excursion/create"
        ...
        <button class="btn btn-primary" type="submit"><f:message key="excursion.create"/></button>
    </form:form>
